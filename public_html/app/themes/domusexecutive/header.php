...
<body <?php body_class('push-menu'); ?>>
	...
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'domusexecutive' ); ?></a>
    ...
    <header id="masthead" class="site-header" itemscope="itemscope" itemtype="http://schema.org/WPHeader" role="banner">
	    <div class="header-wrapper">
            ...
            <div class="logo-container">
                <a href="/" title="Domus Executive"><img src="<?php bloginfo('template_url'); ?>/images/domusexecutive-logo.svg" class="svg" alt="Domus Executive Logo"></a>
            </div>
