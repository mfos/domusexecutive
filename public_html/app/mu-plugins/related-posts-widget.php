...
class Related_Posts_Widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'widget_recent_entries', 'description' => __( "HB Related Posts.") );
        parent::__construct('hb-related-posts', __('Custom Widget: Related Posts'), $widget_ops);
    ...
    public function widget( $args, $instance ) {
        ...
        $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Blogs you may be interested in..' );
